...
export const AI_SALE_SYNC_CHECKBOX_LABEL =
  "ข้าพเจ้าได้ตรวจสอบและยืนยันว่า ข้อมูลรายการขายที่ระบบจะดึงจากใบเสร็จโดยใช้ปัญญาประดิษฐ์ (AI) มีความถูกต้องครบถ้วนและเหมาะสมกับการบันทึกในระบบ ข้าพเจ้าได้ยอมรับความรับผิดชอบต่อความถูกต้องของข้อมูลดังกล่าว และทราบว่าระบบไม่สามารถรับประกันความถูกต้องของผลลัพธ์จาก AI ได้ในทุกกรณี";
